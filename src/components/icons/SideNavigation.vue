  ...
  >
    ...
    >
      ...
      <div :style="{ marginBottom: 'var(--b-spacer-090)' }">
        ...
        <div v-else class="flex flex-col" :style="{ gap: 'var(--b-spacer-010)' }">
          <div
          ...
          >
            <div class="flex items-center" :style="{ gap: 'var(--b-spacer-080)', flex: 1, minWidth: 0, overflow: 'hidden' }">
              <div :style="{ width: 'var(--b-spacer-070)', height: 'var(--b-spacer-070)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, '--fill-0': 'var(--b-color-label-inverse-secondary)' }">
                <icon-star-filled />
              </div>
              <span :style="{ ...bodyStyle, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }">{{ fav }}</span>
            </div>
            <div
      ...
      <div>
        ...
        <nav class="flex flex-col" :style="{ gap: 'var(--b-spacer-010)' }">
          <div v-for="item in navItems" :key="item.label">
            ...
            >
              <div class="flex items-center" :style="{ gap: 'var(--b-spacer-080)', minWidth: 0, overflow: 'hidden' }">
                <div :style="{ width: 'var(--b-spacer-070)', height: 'var(--b-spacer-070)', color: 'inherit', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }">
                  <component :is="item.icon" :size="16" color="currentColor" />
                </div>
                <span :style="{ ...bodyStyle, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }">{{ item.label }}</span>
              </div>
              <div v-if="item.children && item.children.length > 0" class="flex items-center" :style="{ gap: 'var(--b-spacer-010)' }">
              ...
              <div
                ...
                class="cursor-pointer"
                :style="{ width: 'var(--b-spacer-070)', height: 'var(--b-spacer-070)', display: 'flex', alignItems: 'center', justifyContent: 'center', '--fill-0': 'var(--b-color-label-inverse-secondary)' }"
            ...
            <transition name="expand">
              <div v-if="expandedItem === item.label && item.children" class="overflow-hidden">
                <div class="flex flex-col" :style="{ marginTop: 'var(--b-spacer-010)', gap: 'var(--b-spacer-010)' }">
                  <div
