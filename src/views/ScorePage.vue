<template>
  <div class="score-page">
    <div class="page-header">
      <h1>Score</h1>
      <p>View and manage account scoring and risk assessment</p>
    </div>
    
    <div class="content-section">
      <div class="info-card">
        <h3>Score Overview</h3>
        <p>View account scores and risk assessments</p>
      </div>
      
      <div class="info-card">
        <h3>Score History</h3>
        <p>Track score changes and trends over time</p>
      </div>
      
      <div class="info-card">
        <h3>Score Configuration</h3>
        <p>Configure scoring rules and parameters</p>
      </div>
    </div>
  </div>
</template>
