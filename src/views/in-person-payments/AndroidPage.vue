<template>
  <div class="android-page">
    <div class="page-header">
      <h1>Android</h1>
      <p>Manage Android-based payment terminals and applications</p>
    </div>
    
    <div class="content-section">
      <div class="info-card">
        <h3>Android Terminal Management</h3>
        <p>Manage Android-based terminal devices</p>
      </div>
      
      <div class="info-card">
        <h3>App Configuration</h3>
        <p>Configure Android payment applications</p>
      </div>
      
      <div class="info-card">
        <h3>System Updates</h3>
        <p>Manage Android system updates and patches</p>
      </div>
    </div>
  </div>
</template>
