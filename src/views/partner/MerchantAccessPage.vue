<template>
  <div class="merchant-access-page">
    <div class="page-header">
      ...
      <p>Manage merchant access and permissions</p>
    </div>
    
    <div class="content-section">
      <div class="info-card">
        <h3>Access Management</h3>
        <p>Manage merchant access permissions</p>
      </div>
      
      <div class="info-card">
        <h3>Permission Configuration</h3>
        <p>Configure merchant access permissions</p>
      </div>
      
      <div class="info-card">
        <h3>Access Analytics</h3>
        <p>Monitor merchant access and usage</p>
      </div>
    </div>
  </div>
</template>
