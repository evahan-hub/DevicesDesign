  ...
  <div class="payments-page">
    ...
    <div class="content-section">
      <div class="info-card">
        ...
        <p>View all payment transactions and their status</p>
      </div>
      
      <div class="info-card">
        <h3>Payment Methods</h3>
        <p>Manage supported payment methods and configurations</p>
      </div>
      
      <div class="info-card">
        <h3>Transaction History</h3>
        <p>Access detailed transaction history and reports</p>
      </div>
    </div>
  </div>
</template>
