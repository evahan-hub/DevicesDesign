<template>
  <div class="experiments-page">
    <div class="page-header">
      <h1>Experiments</h1>
      <p>Manage and monitor risk experiments and A/B tests</p>
    </div>
    
    <div class="content-section">
      <div class="info-card">
        <h3>Active Experiments</h3>
        <p>View and manage currently running experiments</p>
      </div>
      
      <div class="info-card">
        <h3>Experiment Results</h3>
        <p>Analyze experiment performance and results</p>
      </div>
      
      <div class="info-card">
        <h3>Experiment Configuration</h3>
        <p>Set up and configure new experiments</p>
      </div>
    </div>
  </div>
</template>
