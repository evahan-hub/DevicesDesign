<template>
  <div class="campaigns-page">
    <div class="page-header">
      <h1>Campaigns</h1>
      <p>Manage and track giving campaigns and initiatives</p>
    </div>
    
    <div class="content-section">
      <div class="info-card">
        <h3>Campaign Management</h3>
        <p>Manage and monitor giving campaigns</p>
      </div>
      
      <div class="info-card">
        <h3>Campaign Analytics</h3>
        <p>Track campaign performance and impact</p>
      </div>
      
      <div class="info-card">
        <h3>Campaign Configuration</h3>
        <p>Set up and configure new campaigns</p>
      </div>
    </div>
  </div>
</template>
